<template>
  <h2>Cena {{ contador + 1 }}
    con el rey godo: {{ rey }}
  </h2> <!-- contador sigue siendo 0, sólo que aparece 1 en la vista -->
  ...
  <img :src="imagen" alt=""/>
  <button @:click="siguiente">Siguiente ({{ contador +1 }}/ {{total}})</button> <!-- en esos espacios pondrá el número de "páginas" -->
